...
**[Jamly](https://github.com/sur-shah/jamly)** — Currently building music practice assistant that generates exercises from your preferences and returns quantitative audio feedback from signal processing on your recordings. FastAPI backend, React Native mobile app. Also gained exposure to Claude Code and Codex.

**[SkinLesionAI](https://github.com/sur-shah/SkinLesionAI)** — Real-time skin lesion detection and classification streamed from a mobile camera to a Python backend. Two-stage ML pipeline (YOLOv8 + MobileNetV3) over WebSockets, with results overlaid on the live camera feed in under 150ms. Gained exposure to Claude Code and Cursor.
